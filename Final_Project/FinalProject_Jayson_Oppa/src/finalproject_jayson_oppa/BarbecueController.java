 ...
 * @author jason
 */
public class BarbecueController implements Initializable {
    ...
    private void add() {
        Barbecue p = new Barbecue(PullChickenOrder, ChickenFriedSteakOrder, ChickenSkewersOrder,
