...
public class Chicken implements Food {
    ...
    private double ChickenFriedSteak = 8.99;
    ...
    public Chicken(int PullChickenOrder, int ChickenFriedSteakOrder, int ChickenSkewersOrder, int ChickenBisketOrder,
    ...
    public String toString() {
        String outPut=""; 
        if (getSubtotal()!=0){
            outPut += "Chicken" + "\t\t\tTotalPrice: $" + getSubtotal() + "#";
        }
        if (this.PullChickenOrder > 0) {
            outPut += "> PullChicken" +"\t\t\t\t"+"x"+PullChickenOrder+"#";
        }
        if (this.ChickenFriedSteakOrder > 0) {
            outPut += "> ChickenFriedSteak" +"\t\t"+"x"+ChickenFriedSteakOrder+ "#";
        }
        if (this.ChickenSkewersOrder > 0) {
            outPut += "> ChickenSkewers" +"\t\t\t"+"x"+ChickenSkewersOrder+ "#";
        } 
        if (this.ChickenBisketOrder > 0) {
            outPut += "> ChickenBisket" +"\t\t\t"+"x"+ChickenBisketOrder+ "#";
        }
        if (this.BeffShortRibsOrder > 0) {
            outPut += "> BeffShortRibs" +"\t\t\t"+"x"+BeffShortRibsOrder+ "#";
        }
        if (this.PotatoFriesOrder > 0) {
            outPut += "> Potato Fries" +"\t\t\t\t"+"x"+PotatoFriesOrder+ "#";
        }
//        if (this.Text!=null){
//            outPut += this.Text;
//        }
